...
router.delete("/masters/:woptMstIdx", authMiddleware, WashOptionController.DeleteLogic1);
...
router.delete("/details/:woptDtlIdx", authMiddleware, WashOptionController.DeleteLogic2);
